            ...
            <li><a href="#">Kierunki <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="#">Studia I stopnia<span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a href="informatyka.php">Informatyka</a></li>
                ...
                <li><a href="#">Studia II stopnia<span class="caret"></span></a>
                  <ul class="dropdown-menu">
                     <li><a href="teleinformatyka.php">Teleinformatyka</a></li>
                     <li><a href="elektrotechnika.php">Elektrotechnika</a></li>
                     <li><a href="zarzadzanie.php">Zarządzanie</a></li>
                  </ul>
                </li>
                <li><a href="#">Studia podyplomowe<span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a href="programowanie.php">Programowanie</a></li>
                    <li><a href="zarzadzaniep.php">Zarządzanie projektami</a></li>
                    <li><a href="systemybd.php">Systemy baz danych</a></li>
                  </ul>
                </li>      
