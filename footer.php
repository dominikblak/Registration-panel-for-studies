...
<div >
  <footer class="text-center " style="position:absolute; padding-top: 10px; height: auto;  border: 1px solid silver;  ">


      Dominik Blak &copy; - 2017  
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
              <p class="text-center">
              <button type="button" class="btn btn-success btn-lg" data-dismiss="modal">Zamknij</button>
              </p>
          </div>
        </div>
      </div>
