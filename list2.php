...
<html lang="pl">
  ...
  <body>
    <div class="container">
      <h3>Lista zarejestrowanych kandydatów na studia 2 stopnia</h3>
      ...
      $dane= $pdo->query( "SELECT * FROM candidates where field_of_study='Teleinformatyka'or field_of_study='Elektrotechnika' or field_of_study='Zarządzanie' " );
      ...
      echo '<table border=3>';
        ...
        echo "<tr>";  
                  ...
                  echo '<td><a href="delete2.php?id='.$value['id'].'">Usuń</a></td>';
