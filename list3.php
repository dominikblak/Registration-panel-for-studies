...
<html lang="pl">
  ...
  <body>
    <div class="container">
      <h3>Lista zarejestrowanych kandydatów na studia podyplomowe </h3>
      ...
      $dane= $pdo->query( "SELECT * FROM candidates where field_of_study='Programowanie'or field_of_study='Zarządzanie projektami' or field_of_study='Systemy baz danych' " );
      ...
      echo '<table border=3>';
        ...
        echo "<tr>";  
                  ...
                  echo '<td><a href="delete3.php?id='.$value['id'].'">Usuń</a></td>';
